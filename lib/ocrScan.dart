...
class _ocrScanState extends State<ocrScan> {
  ...
  pickimage(ImageSource source)async{
    ...
    var data = {"base64Image": "data:image/jpg;base64,$img64",
      "isTable": "true", "scale": "true", "isOverlayRequired" : "true"};
    ...
    setState(() {
      ...
      var mylistamount =  totalRegEx.allMatches(scannedText).map((z) => z.group(0)).toList();
      mylistamount.sort();
      String? maxValue = mylistamount.last;
      _totalController.text = maxValue!;
    });
